...
class AlienBot:
    ...
    def cubed_intent(self, number):
        ...
        return print(f"The cube of {number} is {cubed_number}. Isn't that cool? ")

    def no_match_intent(self):
        responses = ("Please tell me more", "Tell me more", "Why do you say that", "Interesting. Can you tell me more? ",
                     "I see. How do you think? ", "How do you think i feel when you say that? ")
        return random.choice(responses)
